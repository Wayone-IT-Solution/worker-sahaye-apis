...
> = {
  ...
  "badge-earned": {
    sender: (ctx) => ({
      ...
      message: `You assigned the badge "${
        ctx?.badgeName || "Unknown Badge"
      }" to ${ctx?.userName || "a user"}.`,
    }),
    receiver: (ctx) => ({
      title: "You've Earned a Badge!",
      message: `Congratulations! You've been awarded the "${
        ctx?.badgeName || "a new"
      }" badge.`,
    }),
  },
  ...
  "job-applied": {
    ...
    receiver: (ctx) => ({
      ...
      message: `${ctx?.applicantName || "A user"} has applied for your job "${
        ctx?.jobTitle || "Untitled"
      }".`,
    }),
  },
  ...
  "job-expiring": {
    sender: (ctx) => ({
      ...
      message: `Your job "${ctx?.jobTitle}" will expire on ${
        ctx?.expiryDate || "soon"
      }.`,
    }),
    receiver: (ctx) => ({
      title: "Job Expiring Soon",
      message: `The job "${ctx?.jobTitle}" is expiring on ${
        ctx?.expiryDate || "soon"
  ...
  "course-added": {
    sender: (ctx) => ({
      title: "Course Added",
      message: `You successfully added the course "${
        ctx?.courseName || "Untitled"
      }".`,
    }),
    receiver: (ctx) => ({
      title: "New Course Available",
      message: `A new course "${
        ctx?.courseName || "Untitled"
  ...
  "course-enrolled": {
    sender: (ctx) => ({
      ...
      message: `${ctx?.userName || "A user"} enrolled in your course "${
        ctx?.courseName || "Untitled"
      }".`,
    }),
    receiver: (ctx) => ({
      title: "Enrollment Confirmed",
      message: `You're now enrolled in the course "${
        ctx?.courseName || "Untitled"
      }".`,
    }),
  },
  ...
  "subscription-renewal": {
    sender: (ctx) => ({
      ...
      message: `${ctx?.userName || "A user"} renewed their ${
        ctx?.planName || "plan"
      } subscription.`,
    }),
    receiver: (ctx) => ({
  ...
  "subscription-expiring": {
    sender: (ctx) => ({
      ...
      message: `${ctx?.userName || "A user"}'s subscription is expiring on ${
        ctx?.expiryDate || "soon"
      }.`,
    }),
    receiver: (ctx) => ({
      title: "Subscription Expiring Soon",
      message: `Your subscription will expire on ${
        ctx?.expiryDate || "soon"
  ...
  "new-community-post": {
    ...
    receiver: (ctx) => ({
      ...
      message: `${ctx?.userName || "Someone"} posted in the community: "${
        ctx?.postTitle || "Untitled"
      }".`,
    }),
  },
  ...
  "reply-on-post": {
    ...
    receiver: (ctx) => ({
      ...
      message: `${ctx?.userName || "Someone"} replied to your post: "${
        ctx?.postTitle || "Untitled"
      }".`,
    }),
  },
  ...
  "admin-message": {
    ...
    receiver: (ctx) => ({
      ...
      message: `${ctx?.adminName || "Admin"} sent you a message: "${
        ctx?.message || "Please review your account."
      }"`,
    }),
  },
