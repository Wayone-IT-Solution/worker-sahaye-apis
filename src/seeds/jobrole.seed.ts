...
const jobRolesByCategory: {
  ...
  "Information Technology": [
    ...
    },
    {
      ...
      description: "Lead development of complex systems and mentor teams",
      minExp: 5,
      minSalary: 800000,
      maxSalary: 2000000,
    },
  ...
  "Artificial Intelligence": [
    ...
    },
    {
      ...
      description: "Conduct AI research and innovation",
      minExp: 4,
      minSalary: 800000,
      maxSalary: 2000000,
    },
  ...
  Cybersecurity: [
    {
      ...
      description: "Implement and maintain security systems",
      minExp: 3,
      minSalary: 600000,
      maxSalary: 1500000,
    },
    {
      ...
      description: "Test system security and identify vulnerabilities",
      minExp: 3,
      minSalary: 650000,
      maxSalary: 1600000,
    },
  ...
  "Banking & Finance": [
    ...
    },
    {
      ...
      description: "Manage investments and financial portfolios",
      minExp: 3,
      minSalary: 600000,
      maxSalary: 1500000,
    },
    {
      name: "Credit Analyst",
      description: "Assess credit risk and loan applications",
      minExp: 2,
      minSalary: 350000,
      maxSalary: 800000,
    },
  ...
  "Sales & Marketing": [
    ...
    {
      name: "Brand Manager",
      description: "Manage brand identity and marketing campaigns",
      minExp: 3,
      minSalary: 500000,
      maxSalary: 1300000,
    },
  ...
  "Content Writing": [
    ...
    {
      name: "Copywriter",
      description: "Write marketing copy and advertisements",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
  ...
  "Product Management": [
    {
      ...
      description: "Manage product lifecycle and strategy",
      minExp: 3,
      minSalary: 700000,
      maxSalary: 1800000,
    },
    {
      ...
      description: "Support product development and management",
      minExp: 0,
      minSalary: 400000,
      maxSalary: 900000,
    },
  ...
  "Healthcare & Medical": [
    ...
    },
    {
      ...
      description: "Operate medical equipment and assist doctors",
      minExp: 1,
      minSalary: 250000,
      maxSalary: 600000,
    },
  ...
  "Nursing Services": [
    {
      ...
      description: "Provide professional nursing care",
      minExp: 0,
      minSalary: 350000,
      maxSalary: 800000,
    },
    {
      name: "Nurse Manager",
      description: "Manage nursing team and operations",
      minExp: 3,
      minSalary: 500000,
      maxSalary: 1100000,
    },
  ...
  Pharmacy: [
    {
      name: "Pharmacist",
      description: "Dispense medication and provide health advice",
      minExp: 0,
      minSalary: 350000,
      maxSalary: 800000,
    },
    {
      ...
      description: "Assist pharmacists in medication management",
      minExp: 0,
      minSalary: 250000,
      maxSalary: 500000,
    },
  ...
  "Mental Health": [
    {
      name: "Psychiatrist",
      description: "Provide mental health treatment",
      minExp: 5,
      minSalary: 600000,
      maxSalary: 1400000,
    },
    {
      name: "Psychologist",
      description: "Provide psychological counseling and therapy",
      minExp: 2,
      minSalary: 400000,
      maxSalary: 900000,
    },
  ...
  "Architecture & Design": [
    ...
    },
    {
      ...
      description: "Design interior spaces and environments",
      minExp: 2,
      minSalary: 400000,
      maxSalary: 1000000,
    },
  ...
  "Graphic Design": [
    ...
    },
    {
      ...
      description: "Create animated graphics and motion content",
      minExp: 2,
      minSalary: 350000,
      maxSalary: 900000,
    },
  ...
  "Education & Training": [
    {
      name: "Teacher",
      description: "Teach students and facilitate learning",
      minExp: 0,
      minSalary: 300000,
      maxSalary: 700000,
    },
    ...
    },
    {
      ...
      description: "Coordinate academic programs and operations",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
  ...
  Consulting: [
    {
      ...
      description: "Provide business consulting and strategy",
      minExp: 3,
      minSalary: 700000,
      maxSalary: 1800000,
    },
  ...
  "Project Management": [
    ...
    {
      name: "Scrum Master",
      description: "Facilitate agile development and team coordination",
      minExp: 2,
      minSalary: 500000,
      maxSalary: 1200000,
    },
  ...
  "Supply Chain Management": [
    ...
    },
    {
      ...
      description: "Coordinate logistics and shipping operations",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
  ...
  "Transportation & Logistics": [
    {
      ...
      description: "Manage logistics operations and distribution",
      minExp: 3,
      minSalary: 600000,
      maxSalary: 1300000,
    },
    {
      name: "Fleet Manager",
      description: "Manage fleet of vehicles and drivers",
      minExp: 3,
      minSalary: 500000,
      maxSalary: 1200000,
    },
  ...
  "Hospitality & Tourism": [
    ...
    {
      name: "Tour Guide",
      description: "Guide tourists and provide information",
      minExp: 0,
      minSalary: 250000,
      maxSalary: 600000,
    },
  ...
  "Event Management": [
    {
      ...
      description: "Coordinate event planning and execution",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
    {
      name: "Events Manager",
      description: "Manage large-scale events and productions",
      minExp: 3,
      minSalary: 500000,
      maxSalary: 1200000,
    },
  ...
  "Food & Beverage": [
    {
      name: "Chef",
      description: "Prepare and cook food items",
      minExp: 2,
      minSalary: 350000,
      maxSalary: 900000,
    },
    ...
    {
      name: "Sommelier",
      description: "Select and serve wines",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
  ...
  "Construction & Real Estate": [
    ...
    },
    {
      ...
      description: "Buy, sell, and lease properties",
      minExp: 0,
      minSalary: 300000,
      maxSalary: 900000,
    },
  ...
  Aviation: [
    ...
    },
    {
      ...
      description: "Serve passengers and ensure safety on flights",
      minExp: 0,
      minSalary: 300000,
      maxSalary: 700000,
    },
    {
      ...
      description: "Maintain aircraft systems and equipment",
      minExp: 3,
      minSalary: 600000,
      maxSalary: 1400000,
    },
  ...
  "Media & Entertainment": [
    ...
    {
      name: "Producer",
      description: "Produce films, shows, or content",
      minExp: 3,
      minSalary: 500000,
      maxSalary: 1300000,
    },
  ...
  "Music & Audio": [
    ...
    {
      name: "Music Producer",
      description: "Produce and arrange music",
      minExp: 2,
      minSalary: 400000,
      maxSalary: 1000000,
    },
  ...
  "Sports & Fitness": [
    {
      name: "Fitness Coach",
      description: "Guide fitness training and workouts",
      minExp: 1,
      minSalary: 250000,
      maxSalary: 600000,
    },
    {
      name: "Sports Manager",
      description: "Manage sports teams and athletes",
      minExp: 2,
      minSalary: 400000,
      maxSalary: 1000000,
    },
  ...
  "Beauty & Wellness": [
    {
      name: "Beautician",
      description: "Provide beauty and cosmetic services",
      minExp: 0,
      minSalary: 200000,
      maxSalary: 500000,
    },
    {
      name: "Wellness Coach",
      description: "Guide health and wellness programs",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
  ...
  "Legal Services": [
    {
      name: "Lawyer",
      description: "Provide legal services and representation",
      minExp: 3,
      minSalary: 600000,
      maxSalary: 1500000,
    },
    {
      ...
      description: "Consult on legal matters",
      minExp: 3,
      minSalary: 500000,
      maxSalary: 1300000,
    },
  ...
  Accounting: [
    {
      name: "Accountant",
      description: "Manage financial records and accounts",
      minExp: 1,
      minSalary: 300000,
      maxSalary: 700000,
    },
    {
      ...
      description: "Provide accounting and audit services",
      minExp: 3,
      minSalary: 600000,
      maxSalary: 1400000,
    },
...
export const seedJobRoles = async () => {
  try {
    ...
    if (existingCount > 0) {
      console.log(
        `✅ Job roles already exist in database (${existingCount} found)`,
      );
      return;
    }
    ...
    for (const category of categories) {
      ...
      if (roles.length > 0) {
        console.log(
          `   📝 Creating ${roles.length} roles for "${categoryName}"`,
        );
    ...
    console.log(
      `✅ Successfully inserted ${result.length} job roles into database`,
    );
    return result;
  } catch (error: any) {
